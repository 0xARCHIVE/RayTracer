...
const float GLOBAL_SETTING_RAY_SPREAD = 10;		// how much rays should scatter at each step (degrees)
const int GLOBAL_SETTING_RAY_NUM_SPAWN = 2;		// how many rays should be spawned at each step
